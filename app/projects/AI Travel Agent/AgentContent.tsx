      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <ul className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li>sendEmail: This tool leverages <strong>SendGrid API </strong>to send the created travel itinerary to travel buddies. After the user provides the emails of whoever needs to receive the email, the agent will parse through this data and make respective API calls. All emails are sent from keshavsheth11@gmail.com</li>
